...
#画像データを読み込み
images = [tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap6-mapfield.png"),
          tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap6-mapwall.png"),
          tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap6-mapgoal.png"),
          tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap6-mapkey.png"),
          tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap6-mapman.png"),
          tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap7-mapmonster.png")]
