...
class FightManager:
    ...
    def __init__(self):
        ...
        #画像の読み込み
        self.images = [
            tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap7-monseter1.png"),
            tkinter.PhotoImage(file="12歳からはじめるゼロからのPythonゲームプログラミング教室/img6/chap7-monster2.png")
        ]
