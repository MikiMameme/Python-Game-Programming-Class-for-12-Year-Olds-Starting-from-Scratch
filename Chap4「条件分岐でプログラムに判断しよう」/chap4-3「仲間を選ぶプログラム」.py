...
#画像読み込み
king_img = tkinter.PhotoImage(file = '12歳からはじめるゼロからのPythonゲームプログラミング教室/img4/chap4-2-1.png')
monsterA_img = tkinter.PhotoImage(file = '12歳からはじめるゼロからのPythonゲームプログラミング教室/img4/chap4-2-2.png')
monsterB_img = tkinter.PhotoImage(file = '12歳からはじめるゼロからのPythonゲームプログラミング教室/img4/chap4-2-3.png')
...
#ラベル配置
sysText = tkinter.Label(text="誰を仲間にしますか？（１：王様、２：魔物A、３：魔物B） ")
